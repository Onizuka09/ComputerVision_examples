...
def main():
    ...
    xPID = PID([1, 0,1], 640 // 2, limit=[-100, 100])
    yPID = PID([1, 0, 1], 480 // 2, axis=1, limit=[-100, 100])
    ...
    while True:
        ...
        if bboxs:
            ...
            cv2.putText(img, f'x:{xVal} , y:{-yVal} ', (0, 100), cv2.FONT_HERSHEY_PLAIN, 3,
                        (255, 0, 0), 3)
            data.sendData([xVal,yVal])
